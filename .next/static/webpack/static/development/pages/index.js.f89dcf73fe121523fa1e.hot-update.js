...
var PayByCredit = function PayByCredit() {
  ...
  var onFormChange = function onFormChange(e) {
    ...
    setCreditData(function (prev) {
      ...
      if (prev[inputName] === 'creditNumber' && inputName.split('-')[1]) {
        var result = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, prev);

        result[creditNumber][InputIndex] = value;
      } else return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, prev, {
        email: value
      });
    });
  };
...
//# sourceMappingURL=index.js.f89dcf73fe121523fa1e.hot-update.js.map